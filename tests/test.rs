...
#[case("Run every 10 minutes Monday through Friday every month", Ok("0 0/10 * ? * MON-FRI *"))]
#[case("Run every 1 minutes Monday through Thursday between 6:00 am and 9:00 pm", Ok("0 0/1 6-21 ? * MON-THU *"))]
#[case("Run every 5 minutes Monday through Thursday between 6:00 am and 9:00 am", Ok("0 0/5 6-9 ? * MON-THU *"))]
#[case("Every 5 minutes, only on Friday", Ok("0 0/5 * ? * FRI *"))]
// Hours
#[case("Run every 3 hours", Ok("0 0 0/3 * * ? *"))]
#[case("Run every 6 hours, starting at 1:00 pm on day Monday", Ok("0 0 0/6 ? * MON *"))]
...
#[case("every 5 day at 4:30 pm Monday through Thursday", Ok("0 30 16 ? * MON-THU *"))]
...
// Year
#[case("every 2 day from January to August in 2020 and 2024", Ok("0 0 0 */2 JAN-AUG ? 2020,2024"))]
// Specific Times (AM/PM)
#[case("Run at 10:00 am", Ok("0 0 10 * * ? *"))]
#[case("Run at 12:15 pm", Ok("0 15 12 * * ? *"))]
#[case("Run at 6:00 pm every Monday through Friday", Ok("0 0 18 ? * MON-FRI *"))]
#[case("Run at noon every Sunday", Ok("0 0 12 ? * SUN *"))]
#[case("Run at midnight on the 1st and 15th of the month", Ok("0 0 0 1,15 * ? *"))]
